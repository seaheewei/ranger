...
class TunnelManagementHttpClient {
    ...
    async createTunnel(tunnel, options) {
        ...
        const result2 = (await this.sendTunnelRequest('PUT', tunnel, manageAccessTokenScope, undefined, undefined, options, this.convertTunnelForRequest(tunnel), undefined, true));
